...
let content = fs.readFileSync('src/services/bags.service.ts', 'utf8');

// Find and replace the getTokenFeed method
const oldMethod = /async getTokenFeed\(\): Promise<TokenLaunch\[\]> \{[\s\S]*?return tokensWithVolume;\s+\}/;
...
console.log('Updated getTokenFeed method to use launchSignature');
